...
var attendance_model_1 = require("~/model/attendance.model");
var behaviour_model_1 = require("~/model/behaviour.model");
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.createDb = function () {
        ...
        var attendance = [
            { id: 1, date: monday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.present },
            { id: 2, date: tuesday, amMark: attendance_model_1.AttendanceMark.late, pmMark: attendance_model_1.AttendanceMark.present },
            { id: 3, date: wednesday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.late },
            { id: 4, date: thursday, amMark: attendance_model_1.AttendanceMark.authorised, pmMark: attendance_model_1.AttendanceMark.late },
            { id: 5, date: friday, amMark: attendance_model_1.AttendanceMark.authorised, pmMark: attendance_model_1.AttendanceMark.authorised },
            { id: 6, date: saturday, amMark: attendance_model_1.AttendanceMark.unauthorised, pmMark: attendance_model_1.AttendanceMark.unauthorised },
            { id: 7, date: nextWeekMonday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.present },
            { id: 8, date: nextWeekTuesday, amMark: attendance_model_1.AttendanceMark.late, pmMark: attendance_model_1.AttendanceMark.present },
            { id: 9, date: nextWeekWednesday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.late },
            { id: 10, date: nextWeekThursday, amMark: attendance_model_1.AttendanceMark.late, pmMark: attendance_model_1.AttendanceMark.late },
            { id: 11, date: nextWeekFriday, amMark: attendance_model_1.AttendanceMark.authorised, pmMark: attendance_model_1.AttendanceMark.authorised },
            { id: 12, date: nextWeekSaturday, amMark: attendance_model_1.AttendanceMark.unauthorised, pmMark: attendance_model_1.AttendanceMark.unauthorised },
            { id: 13, date: n2WeekMonday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.present },
            { id: 14, date: n2WeekTuesday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.present },
            { id: 15, date: n2WeekWednesday, amMark: attendance_model_1.AttendanceMark.late, pmMark: attendance_model_1.AttendanceMark.present },
            { id: 16, date: n2WeekThursday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.late },
            { id: 17, date: n2WeekFriday, amMark: attendance_model_1.AttendanceMark.present, pmMark: attendance_model_1.AttendanceMark.unauthorised },
            { id: 18, date: n2WeekSaturday, amMark: attendance_model_1.AttendanceMark.late, pmMark: attendance_model_1.AttendanceMark.unauthorised },
        ];
        var behaviour = [
            { id: 1, subject: "English", type: behaviour_model_1.BehaviourType.homework, score: 1, date: p2WeekMonday },
            { id: 2, subject: "Math", type: behaviour_model_1.BehaviourType.disruption, score: 1, date: p2WeekMonday },
            { id: 3, subject: "Science", type: behaviour_model_1.BehaviourType.disruption, score: 2, date: p2WeekMonday },
            { id: 4, subject: "Geography", type: behaviour_model_1.BehaviourType.homework, score: 3, date: p2WeekMonday },
            { id: 5, subject: "Math", type: behaviour_model_1.BehaviourType.organisation, score: 1, date: p2WeekMonday },
            { id: 6, subject: "Art and Design", type: behaviour_model_1.BehaviourType.organisation, score: 1, date: p2WeekMonday },
            { id: 7, subject: "Music", type: behaviour_model_1.BehaviourType.disruption, score: 1, date: p2WeekMonday },
            { id: 8, subject: "Science", type: behaviour_model_1.BehaviourType.homework, score: 2, date: p2WeekMonday },
        ];
        var contactdetail = {
        ...
        var homework = [
            { id: 1, studentId: 2, subject: 'Product',
                ...
                dueDate: new Date(dateNow2.setDate(dateNow2.getDate() - 7)), status: homework_model_1.HomeworkStatus.done
            },
            { id: 2, studentId: 2, subject: 'French',
                ...
                dueDate: new Date(dateNow2.setDate(dateNow2.getDate() + 1)), status: homework_model_1.HomeworkStatus.done
            },
            ...
            { id: 7, studentId: 2, subject: 'Biology',
                task: 'You will have a medicine mock the first week back in Year 11.\n\nYou have been revising medicine this half term, and you will need to keep up with this revision over the summer holidays. Many of you have bought revision guides - use them!\n\nI have also attached Medicine and Western revision work books.',
                createdBy: 'Mr French', createdDate: new Date(dateNow1.setDate(dateNow1.getDate() + 1)), attachedFiles: false,
                dueDate: new Date(dateNow2.setDate(dateNow2.getDate() + 1)), status: homework_model_1.HomeworkStatus.todo
            },
            ...
            { id: 13, studentId: 2, subject: 'Chemistry',
                ...
                dueDate: new Date(dateNow2.setDate(dateNow2.getDate() - 15)), status: homework_model_1.HomeworkStatus.removed
            },
            { id: 14, studentId: 1, subject: 'Science',
                task: "Complete the existing products and user profile research so that you are ready to type all the research pages in the first lesson in September. Plan a conclusion for each page (this is the research analysis page but we will be breaking it up in to a paragraph on each page).\n\nYou might also want to write a draft Design Specification as we will complete that in Lesson 2 of Y11.\n\nUse the power point to guide you.",
                createdBy: 'Mr Fixit', createdDate: new Date(dateNow1.setDate(dateNow1.getDate() - 7)), attachedFiles: true,
                dueDate: new Date(dateNow2.setDate(dateNow2.getDate() + 2)), status: homework_model_1.HomeworkStatus.todo
            },
        ...
        var lesson = [
            ...
            { id: 4, userId: 1, startDate: new Date(monday.setHours(10, 0, 0)), endDate: new Date(monday.setHours(10, 30, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 5, userId: 1, startDate: new Date(monday.setHours(10, 30, 0)), endDate: new Date(monday.setHours(11, 0, 0)), teacher: "Ludwig Van Beethoven", subject: subject.music, class: "11Mu1", break: false },
            { id: 6, userId: 1, startDate: new Date(monday.setHours(11, 0, 0)), endDate: new Date(monday.setHours(12, 0, 0)), teacher: "Alan Turing", subject: subject.computing, class: "11Co1", break: false },
            { id: 7, userId: 1, startDate: new Date(monday.setHours(12, 0, 0)), endDate: new Date(monday.setHours(13, 0, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 8, userId: 1, startDate: new Date(monday.setHours(13, 0, 0)), endDate: new Date(monday.setHours(14, 0, 0)), teacher: "Harry James Moore", subject: subject.design, class: "ICT1", break: false },
            { id: 9, userId: 1, startDate: new Date(monday.setHours(14, 0, 0)), endDate: new Date(monday.setHours(15, 0, 0)), teacher: "Norbert Heyes", subject: subject.english, class: "11En1", break: false },
            { id: 10, userId: 1, startDate: new Date(tuesday.setHours(7, 0, 0)), endDate: new Date(tuesday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg", break: false },
            { id: 11, userId: 1, startDate: new Date(tuesday.setHours(8, 0, 0)), endDate: new Date(tuesday.setHours(9, 0, 0)), teacher: "Albert Einstein", subject: "Science", class: "11Sc1", break: false },
            { id: 12, userId: 1, startDate: new Date(tuesday.setHours(9, 0, 0)), endDate: new Date(tuesday.setHours(10, 0, 0)), teacher: "Ferdinand Megellan", subject: subject.english, class: "11Hi1", break: false },
            { id: 13, userId: 1, startDate: new Date(tuesday.setHours(10, 0, 0)), endDate: new Date(tuesday.setHours(10, 30, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 14, userId: 1, startDate: new Date(tuesday.setHours(10, 30, 0)), endDate: new Date(tuesday.setHours(11, 0, 0)), teacher: "Ludwig Van Beethoven", subject: subject.art, class: "11Mu1", break: false },
            { id: 15, userId: 1, startDate: new Date(tuesday.setHours(11, 0, 0)), endDate: new Date(tuesday.setHours(12, 0, 0)), teacher: "Alan Turing", subject: subject.math, class: "11Co1", break: false },
            { id: 16, userId: 1, startDate: new Date(tuesday.setHours(12, 0, 0)), endDate: new Date(tuesday.setHours(13, 0, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 17, userId: 1, startDate: new Date(tuesday.setHours(13, 0, 0)), endDate: new Date(tuesday.setHours(14, 0, 0)), teacher: "Harry James Moore", subject: subject.geography, class: "ICT1", break: false },
            { id: 18, userId: 1, startDate: new Date(tuesday.setHours(14, 0, 0)), endDate: new Date(tuesday.setHours(15, 0, 0)), teacher: "Norbert Heyes", subject: subject.languages, class: "11En1", break: false },
            { id: 19, userId: 1, startDate: new Date(wednesday.setHours(7, 0, 0)), endDate: new Date(wednesday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg", break: false },
            { id: 20, userId: 1, startDate: new Date(wednesday.setHours(8, 0, 0)), endDate: new Date(wednesday.setHours(9, 0, 0)), teacher: "Albert Einstein", subject: subject.science, class: "11Sc1", break: false },
            { id: 21, userId: 1, startDate: new Date(wednesday.setHours(9, 0, 0)), endDate: new Date(wednesday.setHours(10, 0, 0)), teacher: "Edward Thomas", subject: "Physical Education", class: "11Pe1", break: false },
            { id: 22, userId: 1, startDate: new Date(wednesday.setHours(10, 0, 0)), endDate: new Date(wednesday.setHours(10, 30, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 23, userId: 1, startDate: new Date(wednesday.setHours(10, 30, 0)), endDate: new Date(wednesday.setHours(11, 0, 0)), teacher: "Ludwig Van Beethoven", subject: subject.music, class: "11Mu1", break: false },
            { id: 24, userId: 1, startDate: new Date(wednesday.setHours(11, 0, 0)), endDate: new Date(wednesday.setHours(12, 0, 0)), teacher: "Alan Turing", subject: "Computing", class: "11Co1", break: false },
            { id: 25, userId: 1, startDate: new Date(wednesday.setHours(12, 0, 0)), endDate: new Date(wednesday.setHours(13, 0, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 26, userId: 1, startDate: new Date(wednesday.setHours(13, 0, 0)), endDate: new Date(wednesday.setHours(14, 0, 0)), teacher: "Harry James Moore", subject: subject.geography, class: "ICT1", break: false },
            { id: 27, userId: 1, startDate: new Date(wednesday.setHours(14, 0, 0)), endDate: new Date(wednesday.setHours(15, 0, 0)), teacher: "Norbert Heyes", subject: subject.languages, class: "11En1", break: false },
            { id: 28, userId: 1, startDate: new Date(thursday.setHours(7, 0, 0)), endDate: new Date(thursday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg", break: false },
            { id: 29, userId: 1, startDate: new Date(thursday.setHours(8, 0, 0)), endDate: new Date(thursday.setHours(9, 0, 0)), teacher: "Alan Turing", subject: "Computing", class: "11Sc1", break: false },
            { id: 30, userId: 1, startDate: new Date(thursday.setHours(9, 0, 0)), endDate: new Date(thursday.setHours(10, 0, 0)), teacher: "Harry James Moore", subject: "Design and Technology", class: "11Hi1", break: false },
            { id: 31, userId: 1, startDate: new Date(thursday.setHours(10, 0, 0)), endDate: new Date(thursday.setHours(10, 30, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 32, userId: 1, startDate: new Date(thursday.setHours(10, 30, 0)), endDate: new Date(thursday.setHours(11, 0, 0)), teacher: "Ludwig Van Beethoven", subject: "Music", class: "11Mu1", break: false },
            { id: 33, userId: 1, startDate: new Date(thursday.setHours(11, 0, 0)), endDate: new Date(thursday.setHours(12, 0, 0)), teacher: "Albert Einstein", subject: "Science", class: "11Co1", break: false },
            { id: 34, userId: 1, startDate: new Date(thursday.setHours(12, 0, 0)), endDate: new Date(thursday.setHours(13, 0, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 35, userId: 1, startDate: new Date(thursday.setHours(13, 0, 0)), endDate: new Date(thursday.setHours(14, 0, 0)), teacher: "Ferdinand Megellan", subject: "History", class: "ICT1", break: false },
            { id: 36, userId: 1, startDate: new Date(thursday.setHours(14, 0, 0)), endDate: new Date(thursday.setHours(15, 0, 0)), teacher: "Norbert Heyes", subject: "English", class: "11En1", break: false },
            { id: 37, userId: 1, startDate: new Date(friday.setHours(7, 0, 0)), endDate: new Date(friday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg", break: false },
            { id: 38, userId: 1, startDate: new Date(friday.setHours(8, 0, 0)), endDate: new Date(friday.setHours(9, 0, 0)), teacher: "Albert Einstein", subject: "Science", class: "11Sc1", break: false },
            { id: 39, userId: 1, startDate: new Date(friday.setHours(9, 0, 0)), endDate: new Date(friday.setHours(10, 0, 0)), teacher: "Ferdinand Megellan", subject: "History", class: "11Hi1", break: false },
            { id: 40, userId: 1, startDate: new Date(friday.setHours(10, 0, 0)), endDate: new Date(friday.setHours(10, 30, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 41, userId: 1, startDate: new Date(friday.setHours(10, 30, 0)), endDate: new Date(friday.setHours(11, 0, 0)), teacher: "Ludwig Van Beethoven", subject: "Music", class: "11Mu1", break: false },
            { id: 42, userId: 1, startDate: new Date(friday.setHours(11, 0, 0)), endDate: new Date(friday.setHours(12, 0, 0)), teacher: "Alan Turing", subject: "Computing", class: "11Co1", break: false },
            { id: 43, userId: 1, startDate: new Date(friday.setHours(12, 0, 0)), endDate: new Date(friday.setHours(13, 0, 0)), teacher: "", subject: "", class: "", break: true },
            { id: 44, userId: 1, startDate: new Date(friday.setHours(13, 0, 0)), endDate: new Date(friday.setHours(14, 0, 0)), teacher: "Harry James Moore", subject: "Design and Technology", class: "ICT1", break: false },
            { id: 45, userId: 1, startDate: new Date(friday.setHours(14, 0, 0)), endDate: new Date(friday.setHours(15, 0, 0)), teacher: "Norbert Heyes", subject: "English", class: "11En1", break: false },
        ...
        var period = [
            ...
            { id: 43, name: "Morning Break", startDate: new Date(monday.setHours(10, 0, 0)), endDate: new Date(monday.setHours(10, 30, 0)) },
            { id: 44, name: "Afternoon Break", startDate: new Date(monday.setHours(12, 0, 0)), endDate: new Date(monday.setHours(13, 0, 0)) },
            { id: 45, name: "Morning Break", startDate: new Date(tuesday.setHours(10, 0, 0)), endDate: new Date(tuesday.setHours(10, 30, 0)) },
            { id: 46, name: "Afternoon Break", startDate: new Date(tuesday.setHours(12, 0, 0)), endDate: new Date(tuesday.setHours(13, 0, 0)) },
            { id: 47, name: "Morning Break", startDate: new Date(wednesday.setHours(10, 0, 0)), endDate: new Date(wednesday.setHours(10, 30, 0)) },
            { id: 48, name: "Afternoon Break", startDate: new Date(wednesday.setHours(12, 0, 0)), endDate: new Date(wednesday.setHours(13, 0, 0)) },
            { id: 49, name: "Morning Break", startDate: new Date(thursday.setHours(10, 0, 0)), endDate: new Date(thursday.setHours(10, 30, 0)) },
            { id: 50, name: "Afternoon Break", startDate: new Date(thursday.setHours(12, 0, 0)), endDate: new Date(thursday.setHours(13, 0, 0)) },
            { id: 51, name: "Morning Break", startDate: new Date(friday.setHours(10, 0, 0)), endDate: new Date(friday.setHours(10, 30, 0)) },
            { id: 52, name: "Afternoon Break", startDate: new Date(friday.setHours(12, 0, 0)), endDate: new Date(friday.setHours(13, 0, 0)) },
            { id: 53, name: "Morning Break", startDate: new Date(saturday.setHours(10, 0, 0)), endDate: new Date(saturday.setHours(10, 30, 0)) },
            { id: 54, name: "Afternoon Break", startDate: new Date(saturday.setHours(12, 0, 0)), endDate: new Date(saturday.setHours(13, 0, 0)) },
        ];
        dateNow1 = new Date();
        var user = [
            { id: 1, fname: 'Jay', mname: '', lname: 'Smith', username: '1', password: '1', birthdate: '1',
                ...
                isfirsttime: false, usertype: user_model_1.UserType.student, hasIncompleteHomework: true, image: '~/images/dp1.jpg',
            ...
            { id: 2, fname: 'Emily', mname: '', lname: 'Smith', username: 'student1', password: 'password', birthdate: '02/03/2001',
                ...
                isfirsttime: true, usertype: user_model_1.UserType.student, hasIncompleteHomework: false, image: '~/images/dp2.jpg',
                lastpwupdate: dateNow1, lastlogin: dateNow1,
                children: []
            },
            { id: 3, fname: 'Grace', mname: '', lname: 'Smith', username: 'student2', password: 'password', birthdate: '03/03/1978',
                ...
                isfirsttime: false, usertype: user_model_1.UserType.student, hasIncompleteHomework: false, image: '~/images/dp3.jpg',
                lastpwupdate: dateNow1, lastlogin: dateNow1,
                children: []
            },
            { id: 4, fname: 'Finn', mname: 'Johnson', lname: 'Williams', username: 'student3', password: 'password', birthdate: '04/05/1975',
                ...
                isfirsttime: false, usertype: user_model_1.UserType.student, hasIncompleteHomework: false, image: '~/images/dp4.jpg',
                lastpwupdate: dateNow1, lastlogin: dateNow1,
                children: []
            },
            { id: 5, fname: 'Jason', mname: '', lname: 'Smith', username: 'parent', password: 'parent', birthdate: '1',
                ...
                isfirsttime: false, usertype: user_model_1.UserType.parent, hasIncompleteHomework: null, image: '~/images/dp5.jpg',
                lastpwupdate: dateNow1, lastlogin: dateNow1,
                children: [
                    { id: 1, fname: 'Jay', mname: '', lname: 'Smith', username: '1', password: '1', birthdate: '1',
                        emailprimary: encodeURIComponent('jaysmith@email.com'), emailsecondary: encodeURIComponent('jaysmith2@email.com'),
            ...
            { id: 6, fname: 'Bon', mname: 'Johnson', lname: 'Williams', username: 'parent1', password: 'parent', birthdate: '01/02/1950',
                ...
                isfirsttime: true, usertype: user_model_1.UserType.parent, hasIncompleteHomework: null, image: '',
                lastpwupdate: dateNow1, lastlogin: dateNow1,
                children: [
                    { id: 4, fname: 'Finn', mname: 'Johnson', lname: 'Williams', username: 'student3', password: 'password', birthdate: '04/05/1975',
                        phoneprimary: '9456', phonesecondary: '',
            ...
            { id: 7, fname: 'Maria', mname: '', lname: 'Brown', username: 'parent2', password: 'parent', birthdate: '02/01/1950',
                ...
                isfirsttime: false, usertype: user_model_1.UserType.parent, hasIncompleteHomework: null, image: '',
                lastpwupdate: dateNow1, lastlogin: dateNow1,
                children: []
            }
        ];
        return { achievement: achievement, advert: advert, attendance: attendance, behaviour: behaviour, contactdetail: contactdetail, homework: homework, lesson: lesson, notification: notification, period: period, user: user };
    };
    return DataService;
}());
