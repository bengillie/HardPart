...
export class HttpService {
	...
	constructor(private http: HttpClient, private errorService: ErrorService, private authorizationService: AuthorizationService, private appValuesService: AppValuesService) {
	...
	public async Post<T>(url: string, body: any, DebounceTime?: number): Promise<T> {
		const fullUrl = this.baseUrl + url;
		this.configureHeaders(new HttpParams());
	...
	public async PostWithParams<T>(url: string, body: any, params: HttpParams): Promise<T> {
		const fullUrl = this.baseUrl + url;
		this.configureHeaders(params);
