...
export class HomeworkDetailComponent implements OnInit, OnDestroy {
	...
	constructor(private route: ActivatedRoute, private homeworkService: HomeworkService, private location: Location) {}
	...
	getHomework(): void {
		...
		this.subscriptions.push(
			this.homeworkService.getHomework(id).subscribe(
				x => {
					this.homework = x;
				},
				() => {},
