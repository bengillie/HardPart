...
export class DataService implements InMemoryDbService {
  createDb() {
    ...
    const lessons: Lesson[] = [
      ...
      { id: 19, userId: 1, startDate: new Date(wednesday.setHours(7, 0, 0)), endDate: new Date(wednesday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg"},
      ...
      { id: 28, userId: 1, startDate: new Date(thursday.setHours(7, 0, 0)), endDate: new Date(thursday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg"},
      { id: 29, userId: 1, startDate: new Date(thursday.setHours(8, 0, 0)), endDate: new Date(thursday.setHours(9, 0, 0)), teacher: "Alan Turing", subject: "Computing", class: "11Sc1"},
      { id: 30, userId: 1, startDate: new Date(thursday.setHours(9, 0, 0)), endDate: new Date(thursday.setHours(10, 0, 0)), teacher: "Harry James Moore", subject: "Design and Technology", class: "11Hi1"},
      ...
      { id: 33, userId: 1, startDate: new Date(thursday.setHours(11, 0, 0)), endDate: new Date(thursday.setHours(12, 0, 0)), teacher: "Albert Einstein", subject: "Science", class: "11Co1"},
      ...
      { id: 35, userId: 1, startDate: new Date(thursday.setHours(13, 0, 0)), endDate: new Date(thursday.setHours(14, 0, 0)), teacher: "Ferdinand Megellan", subject: "History", class: "ICT1"},
      ...
      { id: 37, userId: 1, startDate: new Date(friday.setHours(7, 0, 0)), endDate: new Date(friday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg"},
      ...
      { id: 46, userId: 1, startDate: new Date(saturday.setHours(7, 0, 0)), endDate: new Date(saturday.setHours(8, 0, 0)), teacher: "Matthew Downs", subject: subject.reg, class: "Reg"},
    ...
    const user: User[] = [
      ...
      { id: 5, fname: 'Jason', mname: '', lname: 'Smith', username: 'parent', password: 'parent', birthdate: '01/01/1950', 
        email: encodeURIComponent('jasonsmith@email.com'), usertype: UserType.parent, hasIncompleteHomework: null, image: '',
        children: [
            { id: 1, fname: 'Jay', mname: '', lname: 'Smith', username: '1', password: '1', birthdate: '1', 
              email: encodeURIComponent('jaysmith@email.com'), usertype: UserType.student, hasIncompleteHomework: true, image: '~/images/dp1.jpg',
              children: []
